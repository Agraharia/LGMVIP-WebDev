                    ...
                    <div class="main-page" style="background-color: LightGray;">
                        <div class="container-fluid" >
                            <div class="row page-title-div" style="background-color: LightGray;">
                                <div class="col-sm-6">
                                    <b><h2 class="title" style="text-decoration: underline;">DASHBOARD</h2></b>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-primary" href="manage-students.php" style="background-color: MediumAquaMarine;">
<?php
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="manage-subjects.php" style="background-color: MediumAquaMarine;">
<?php
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-warning" href="manage-classes.php" style="background-color: MediumAquaMarine;">
                                        <?php
...
?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-success" href="manage-results.php" style="background-color: MediumAquaMarine;">
                                        <?php
